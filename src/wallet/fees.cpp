...
{   // NOTE: DATACOIN fee - allow free == false
    ...
    */
    ...
    // NOTE: DATACOIN fee. Not less than MIN_TX_FEE - Consensus rule
    // And no less tx.GetMinFee(1000, false, GMF_RELAY) for memory
    // Data fee is not required at all but old clients (and we) still
    // make it when creating a transaction.
